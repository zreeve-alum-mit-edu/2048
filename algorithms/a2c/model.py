"""
A2C Actor-Critic Network Model.
...
class ActorCriticNetwork(nn.Module):
    ...
    This shared architecture allows the actor and critic to share
    learned features, which can be more sample efficient.
    ...
    def __init__(
        ...
        num_actions: int = 4,  # 4 actions (up, down, left, right)
        activation: str = "relu"
    ):
