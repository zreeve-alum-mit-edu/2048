"""
SARSA(lambda) Q-Network Model.

Q-network for SARSA(lambda) - similar to SARSA but outputs are used
with eligibility traces for multi-step credit assignment.
...
class SARSALambdaNetwork(nn.Module):
    """Q-Network for SARSA(lambda) algorithm.
    ...
    def __init__(
        ...
        """Initialize SARSA(lambda) network.
